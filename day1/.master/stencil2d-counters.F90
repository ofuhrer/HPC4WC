...
program main
    ...
    if ( is_master() ) then
        write(*, '(a)') '# ranks nx ny nz num_iter time flop byte'
    ...
    subroutine apply_diffusion( in_field, out_field, alpha, num_iter, increase_counters )
        ...
        do iter = 1, num_iter
            ...
            do i = 1 + num_halo, nx + num_halo
                ...
                ! hpc4wc:student | ! TODO (-> this is an example of how to fill in the other TODO's!)
                ! hpc4wc:student | if (increase_counters) flop_counter = flop_counter + 2
                ! hpc4wc:student | if (increase_counters) byte_counter = byte_counter + 3 * wp
                ! hpc4wc:student-end
