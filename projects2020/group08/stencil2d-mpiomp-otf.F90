...
program main
    ...
    do cur_setup = 0, num_setups - 1
        ...
        if ( .not. scan .and. is_master() ) &
            call write_field_to_file( in_field, num_halo, "in_field_mpiomp.dat" )
        ...
        if ( .not. scan .and. is_master() ) &
            call write_field_to_file( out_field, num_halo, "out_field_mpiomp_otf.dat" )
