! ******************************************************
!     Program: stencil2d-IrecvIsend
!     Author: Victoria Bauer, Sarina Danioth, Julia Dworzak
!     Email: vbauer@ethz.ch
!     Date: 26.07.2022
!     Description: Parallel stencil example (4th-order diffusion) with IRecvIsend communication
! ******************************************************
...
contains
    ...
    !
    subroutine apply_diffusion( in_field, out_field, alpha, num_iter, p, runtime_halo )
        implicit none
