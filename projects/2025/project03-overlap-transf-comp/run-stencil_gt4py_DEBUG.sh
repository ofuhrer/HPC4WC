#!/bin/bash
#SBATCH --job-name=stencil_gt4py_DEBUG
#SBATCH --output=build/stencil_gt4py_DEBUG_%j.out   # Save STDOUT to build dir
#SBATCH --error=build/stencil_gt4py_DEBUG_%j.err    # Save STDERR to build dir
#SBATCH --ntasks=1
...
FILENAME="stencil_gt4py_DEBUG_$SLURM_JOB_ID"
