#!/bin/bash
#SBATCH --job-name=stencil_gt4py_gpu_notransfer
#SBATCH --output=build/stencil_gt4py_gpu_notransfer_%j.out   # Save STDOUT to build dir
#SBATCH --error=build/stencil_gt4py_gpu_notransfer_%j.err    # Save STDERR to build dir
#SBATCH --ntasks=1
...
FILENAME="stencil_gt4py_gpu_notransfer_$SLURM_JOB_ID"
