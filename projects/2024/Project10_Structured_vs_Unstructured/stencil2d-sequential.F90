! ******************************************************
!     Program: stencil2d-sequential
!      Author: Oliver Fuhrer; modified by group10
!       Email: oliverf@vulcan.com
!        Date: 20.05.2020
! Description: Simple stencil example (4th-order diffusion); sequential mapping method implemented
! ******************************************************
...
program main
    ...
    integer, allocatable :: xPoint(:), yPoint(:) ! nPoint
    ...
    integer :: nx_setups(7) = (/ 16, 32, 64, 128, 256, 512, 1024 /)
    integer :: ny_setups(7) = (/ 16, 32, 64, 128, 256, 512, 1024 /)
...
contains
    ...
    subroutine mapping()
        ...
        ! loop to do sequential indexing
        idx = 1; xPoint = 0; yPoint = 0
        do j = 1, ny
            do i = 1, nx
                xPoint(idx) = i
                yPoint(idx) = j
    ...
    subroutine cleanup()
        ...
        deallocate(in_field, out_field, in_field_structured, out_field_structured)
