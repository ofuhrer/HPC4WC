! ******************************************************
!     Program: stencil2d
!      Author: Lena Fasnacht
!       Email: lfasnacht@student.ethz.ch
!        Date: 23.07.2024
...
program main
    ...
    if ( this_image() == 1 ) then
        ...
        write(*, '(a)') '# images nx ny ny nz num_iter time'
    ...
    do cur_setup = 0, num_setups - 1
        ...
        if ( this_image() == 1 ) &
            write(*, '(a, i5, a, i5, a, i5, a, i5, a, i8, a, e15.7, a)') &
                '[', num_images(), ',', nx, ',', ny, ',', nz, ',', num_iter, ',', runtime, '], \'
