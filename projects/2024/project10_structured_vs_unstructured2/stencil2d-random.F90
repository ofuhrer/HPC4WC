! ******************************************************
!     Program: stencil2d-random
!      Author: Oliver Fuhrer; modified by group10
!       Email: oliverf@vulcan.com
!        Date: 20.05.2020
! Description: Simple stencil example (4th-order diffusion); random mapping method implemented
! ******************************************************
...
contains
    ...
    subroutine mapping()
        ...
        if ( allocated(idx) .and. &
            any( shape(idx) /= (/nPoint/) ) ) then
            deallocate( idx )
        end if
