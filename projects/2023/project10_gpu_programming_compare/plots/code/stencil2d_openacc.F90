...
program main
    ...
    integer :: nx_setups(19) = (/ 16,32,48,64,80,96,112,128,144,160,176,192,208,224,240,256,272,288,304 /)
    integer :: ny_setups(19) = (/ 16,32,48,64,80,96,112,128,144,160,176,192,208,224,240,256,272,288,304 /)
    ...
    do cur_setup = 0, num_setups - 1
        ...
        if ( is_master() ) &
            ...
            write(*, '(a, i5, a, i5, a, i5, a, i8, a, f10.3, a)') &
                '[', nx, ',', ny, ',', nz, ',', num_iter, ',', runtime * 1000, '], \'
...
contains
    ...
    subroutine apply_diffusion( in_field, out_field, alpha, num_iter )
        ...
        do iter = 1, num_iter
            ...
            ! second horizontal laplacian and time update
