...
import toroidal_physics.toroidal_physics as tp
...
class Solver:
    ...
    * v			latitudinal fluid velocity
    ...
    def __init__(self, T, M, N, IC, CFL, diffusion):
        ...
        # --- TO-DO: change the latitude to torodial direction and allow periodicity
    ...
    def LaxWendroff(self, h, u, v):
        ...
        # surface tangential gravity component (y or theta direction)
